...
<div class="navbar-container container-fluid p-0 pt-1 border-bottom bg-primaria">
    ...
    <!-- Toggler do Modal -->
    <button type="button" class="btn" id="icone_menu" data-bs-toggle="modal" data-bs-target="#modalId">
    ...
    <div class="container-fluid w-50 justify-content-center">
            <div class="w-100 border border-2 rounded-end-pill rounded-start-pill d-flex d-inline-flex">
                ...
                <input id="Campode Pesquisa" class="form-control border-0 bg-transparent fts-4 w-100 pesquisa" type="search" placeholder="Search" aria-label="Search">
            </div>
    </div>
