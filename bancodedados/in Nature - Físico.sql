...
INSERT INTO PREPARO_INDICACAO (FK_PREPARO_cod_prp, FK_INDICACAO_cod_inc)
VALUES
    (1, 1),
    (1, 6),
    (1, 7),
...
INSERT INTO PREPARO_CONTRAINDICACAO (FK_PREPARO_cod_prp, FK_CONTRAINDICACAO_cod_cinc)
VALUES
    (1, 1),
    (1, 4),
    (1, 7),
...
INSERT INTO PREPARO_EFEITO_COLATERAL (FK_PREPARO_cod_prp, FK_EFEITO_COLATERAL_cod_eftcol)
VALUES
    (1, 1),
    (1, 6),
    (1, 7),
